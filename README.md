...
| Plugin | Skills |
|---|---|
| `engineering` | code-craftsmanship, cli-design, service-application-design, product-ui-design, layout-forensics, style-pass, web-compliance, health-critical-audit, fork-stewardship, spec-writing, project-conception, reverse-engineering |
