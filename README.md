...
| Plugin | Skills |
|---|---|
| `engineering` | code-craftsmanship, cli-design, service-application-design, product-ui-design, layout-forensics, style-pass, web-compliance, fork-stewardship, spec-writing, project-conception |
