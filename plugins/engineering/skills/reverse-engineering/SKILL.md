...
`<skill-dir>/scripts/ghidra-headless`); for shells and agents that run
without the skill loaded, a symlink from a `PATH` directory does. They need radare2 with `r2ghidra` and `r2dec`, `uv`,
Ghidra and a JDK 21.
